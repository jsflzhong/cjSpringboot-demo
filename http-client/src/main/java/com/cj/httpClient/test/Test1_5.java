...
public class Test1_5 {
     ...
     */
    public static void findTargetSumSubsets(Double[] input, int target, String ramp, int index) {
     ...
     */
    private static Double getSum(String intString) {
        Double sum = 0.0;
        StringTokenizer sTokens = new StringTokenizer(intString, token);
        while (sTokens.hasMoreElements()) {
            sum += Double.parseDouble((String) sTokens.nextElement());
        }
        return sum;
    }
    ...
    public static void main(String[] args) {
        ...
        Double[] n = Test1_2.getSourceSet().toArray(new Double[0]);
