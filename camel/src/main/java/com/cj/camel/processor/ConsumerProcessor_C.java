...
@Component
public class ConsumerProcessor_C implements Processor {

    Logger logger = LoggerFactory.getLogger(ConsumerProcessor_C.class);
    ...
    public void process(Exchange exchange) throws Exception {
        logger.info("@@@ConsumerProcessor_C is running......");
        ...
        exchange.getOut().setBody("<html><body>ConsumerProcessor_C :the conditionId is: [" + conditionId + "] </body></html>");

        logger.info("@@@ConsumerProcessor_C finished......");
    }
