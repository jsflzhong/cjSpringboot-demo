...
@Component
public class ConsumerProcessor_A implements Processor {

    Logger logger = LoggerFactory.getLogger(ConsumerProcessor_A.class);
    ...
    public void process(Exchange exchange) throws Exception {
        logger.info("@@@ConsumerProcessor_A is running......");
        ...
        exchange.getOut().setBody("<html><body>ConsumerProcessor_A: the conditionId is: [" + conditionId + "] </body></html>");

        logger.info("@@@ConsumerProcessor_A finished......");
    }
